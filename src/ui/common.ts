...
export const AVAILABLE_ICONS = [
  { id: 'snowflake', svg: ICON_SNOWFLAKE, label: 'Freezer' },
  { id: 'fridge', svg: ICON_FRIDGE, label: 'Refrigerator' },
  { id: 'pantry', svg: ICON_PANTRY, label: 'Pantry' },
  { id: 'closet', svg: ICON_CLOSET, label: 'Closet' },
];

export function getIcon(id?: string): string {
  const icon = AVAILABLE_ICONS.find((i) => i.id === id);
  return icon ? icon.svg : ICON_SNOWFLAKE;
}
